    ...
    <div className='flex items-center justify-between py-5 font-medium'>
      ...
      <div className='flex items-center gap-6'>
        ...
        <div className='relative group'>
          ...
          <div className='absolute right-0 hidden pt-2 group-hover:block dropdown-menu'>
            <div className='flex flex-col w-40 gap-4 px-5 py-3 text-gray-500 rounded bg-slate-100'>
        ...
        <Link to="/cart" className='relative'>
          <img src={assets.cart} className='w-7 min-w-6' alt="Cart"/>
          <p className='absolute right-[-5px] bottom-[-5px] w-3.5 text-center leading-4 bg-black text-white aspect-square rounded-full text-[8px]'>{getCartCount()}</p>
        </Link>
